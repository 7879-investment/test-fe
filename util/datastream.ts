...
const mapXIgniteToData = (prev: RealTimePriceQuote, data: IXIgnitePrice[]): RealTimePriceQuote => {
...
const defaultFunction: MetalStreamFunction = (data: RealTimePriceQuote) => console.log(data)

export const subscribeToUpdates = async (streamUrl: string, onOpen: MetalStreamFunction = defaultFunction, onUpdate: MetalStreamFunction = defaultFunction) => {
    const url = streamUrl;
